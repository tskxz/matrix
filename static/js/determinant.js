...
form.addEventListener("submit", async function (e) {
        ...
        try {
                ...
                exportBtn.onclick = () =>
                        exportDeterminantAsJSON(payload.matrix, result.result);
                ...
                exportXMLBtn.onclick = () =>
                        exportDeterminantAsXML(payload.matrix, result.result);
                ...
                exportHTMLBtn.onclick = () =>
                        exportDeterminantAsHTML(payload.matrix, result.result);
